...
typedef enum {
    SneakyInputDirectionUp,
    SneakyInputDirectionRight,
    SneakyInputDirectionDown,
    SneakyInputDirectionLeft
} SneakyInputDirection;
...
@property (nonatomic, assign) Arrow *arrow;
